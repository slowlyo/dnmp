Docker deploying Nginx MySQL PHP7/PHP5.6/PHP8 in one key, support full feature functions.
...
Default, we create multiple php containers, such as PHP7, PHP5.6 and PHP8.x,
